...
document.addEventListener('DOMContentLoaded', () => {
  ...
  analyzeBudgetButton.addEventListener('click', async (event) => {
    ...
    For each category where the bool is true, Explain why they are doing good and give any relevant advice. If the bool is false, suggest important changes the user should make. The text should always be displayed the same when you send the data.`;
